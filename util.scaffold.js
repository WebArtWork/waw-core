...
const projectRepoList = {
	...
	"waw Angular business opearting system": "https://github.com/WebArtWork/ngx-bos.git",
...
const space = {
	itkp: {
		...
		"Angular business opearting system project": "https://github.com/IT-Kamianets/ngx-bos.git",
